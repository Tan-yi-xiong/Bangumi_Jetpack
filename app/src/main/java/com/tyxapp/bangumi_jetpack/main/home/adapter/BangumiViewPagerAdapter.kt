...
import com.tyxapp.bangumi_jetpack.main.home.FollowBangumiFragment
import com.tyxapp.bangumi_jetpack.main.home.NetWorkBangumiFragment
...
class BangumiViewPagerAdapter(
    ...
    private val tabWithFragments = mapOf(
            ...
            MY_FOLLOW_BANGUMI to { FollowBangumiFragment.newInstance() }
    )
