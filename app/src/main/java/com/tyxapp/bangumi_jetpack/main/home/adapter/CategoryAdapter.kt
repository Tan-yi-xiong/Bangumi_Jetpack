...
import com.tyxapp.bangumi_jetpack.main.home.HomeFragmentDirections
...
class CategoryAdapter: ListAdapter<CategorItem, CategoryViewHolder>(CategoryDiffCallBack()) {

    private var lastPosition = 0

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryViewHolder {
        return CategoryViewHolder(DataBindingUtil.inflate(
    ...
    fun bind(categorItem: CategorItem) {
        with(bind) {
            ...
            bind.cover.setOnClickListener {
                ...
                val directions = HomeFragmentDirections.actionHomeFragmentToCategoryDetailFragment(categorItem.categorName)
                activity.findNavController(R.id.main_content).navigate(directions)
            }
