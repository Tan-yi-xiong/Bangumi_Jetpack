...
class MainActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainViewModel.showUpdateDialog.observe(this) { apkInfo ->
            LOGI(apkInfo.updateMessage)
            alertBuilder(R.string.text_app_update_title) {
                this.setMessage(apkInfo.updateMessage)
