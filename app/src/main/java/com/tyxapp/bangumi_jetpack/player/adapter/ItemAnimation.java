...
/**
 * 复制源码[DefaultItemAnimator],修改了animateAdd和animateAddImpl方法
 *
 */
public class ItemAnimation extends SimpleItemAnimator {
    ...
    public boolean animateAdd(final RecyclerView.ViewHolder holder) {
        ...
        holder.itemView.setTranslationY(250);
    ...
    void animateAddImpl(final RecyclerView.ViewHolder holder) {
        ...
        final int posistion = holder.getAdapterPosition();
        animation.alpha(1).setDuration(250)
                .translationY(0)
                .setInterpolator(new DecelerateInterpolator())
                .setStartDelay(posistion * 150)
